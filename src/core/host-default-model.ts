...
export function resolveDshHome(fallback: string): string {
 ...
 */
export function readHostDefaultModel(dshHome: string): ModelSelectionLike | undefined {
  try {
 ...
 */
export function parseAgentDefaultModel(text: string): ModelSelectionLike | undefined {
  let inBlock = false

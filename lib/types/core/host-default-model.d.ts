...
export declare function resolveDshHome(fallback: string): string;
/**
 ...
 */
export declare function readHostDefaultModel(dshHome: string): ModelSelectionLike | undefined;
/**
 ...
 */
export declare function parseAgentDefaultModel(text: string): ModelSelectionLike | undefined;

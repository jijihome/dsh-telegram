...
import { handleMenuCallback, mainMenuKeyboard, mainMenuText } from './menu.js';
...
export class BotManager {
    ...
    async handleCallback(runtime, callbackQuery) {
        ...
        this.options.logger?.warn(`[tg] bot "${scope.botId}" menu callback "${data}" user=${menuCtx.userId} chat=${chatId} canOperate=${menuCtx.canOperate}`);
        try {

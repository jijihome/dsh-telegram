 ...
 */
export function isUserFacingSessionId(id) {
 ...
 */
export function isOwnSessionId(id) {
 ...
 */
export function workspaceMemberIdsToAdd(existing, members, archived) {
    const out = [];
    const seen = new Set(existing);
    for (const id of members) {
        if (id === '' || seen.has(id) || archived.has(id))
            continue;
        out.push(id);
        seen.add(id);
    }
 ...
 */
export function dropBlankSessions(list, activeId) {
